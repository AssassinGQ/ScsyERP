...
create table t_truck_log (
  ...
  gpxy                DOUBLE(6,2) NOT NULL                 COMMENT '纬度',
...
## 权限的初始化数据
insert into t_truck_log(corporation, out_storage_form, truck, time, distance, gpsx, gpxy, speed, fuel_vol, left_tire_pressure, right_tire_pressure, left_tire_temp, right_tire_temp, has_warn)
